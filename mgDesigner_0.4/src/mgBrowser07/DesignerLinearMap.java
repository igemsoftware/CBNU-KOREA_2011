...
public class DesignerLinearMap extends JFrame implements SequenceViewerMotionListener {
  ...
  public DesignerLinearMap(String fileName, int windowNum){
	
    super("Linear Designer Browser");
	DesignerLinearMap.windowNum = windowNum; 
    try {    	 //Load the sequence file
    ...
    setLocation(594 + nCascade * DesignerLinearMap.windowNum,605);          //linear genome browser의 위치
    DesignerLinearMap.windowNum = DesignerLinearMap.windowNum +1;
...
/*  public static void main(String args []){
    if (args.length == 2){
      new DesignerLinear(args[0], args[1]);
    }
    else {
