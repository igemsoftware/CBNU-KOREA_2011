...
public class DesignerLinear extends JFrame implements SequenceViewerMotionListener {
  ...
  public DesignerLinear(String fileName, int windowNum){
	
    super("Linear Designer Browser");
	DesignerLinear.windowNum = windowNum; 
    ...
    setLocation(594 + nCascade * DesignerLinear.windowNum,605);          //linear genome browser의 위치
    DesignerLinear.windowNum = DesignerLinear.windowNum +1;
