...
class DesignerExtractInformation {
	...
	DesignerExtractInformation(String fileName) {                                //유전체 자료에서 COG GO 유전자 이름 동의어 , 산물 기능 등 보다 많은 정보를 추출하기 위함
...
*/	
	...
	public static void main(String[] args) throws IllegalSymbolException {
		...
		String sFile = args[0];
		DesignerExtractInformation gAnn = new DesignerExtractInformation(sFile);  //gAnn을 해결!!!!!!!!!!!!!!!
/*
